...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "shad.pictures — Cinematic vintage photography" },
      { property: "og:description", content: "Dreamy, romantic vintage 90s style photography. Memories caught in time, not posed." },
